...
const peopleIcon = `<svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="512.000000pt" height="512.000000pt" viewBox="0 0 512.000000 512.000000" preserveAspectRatio="xMidYMid meet"><g transform="matrix(0.12262, 0, 0, -0.12262, -156.467102, -4863.772949)" fill="" stroke="none" style="transform-origin: 112.488px 4839.39px;"><path d="M2345 4629 c-982 -103 -1755 -882 -1855 -1868 -68 -682 219 -1373 753 -1810 421 -344 977 -513 1508 -461 729 73 1357 506 1675 1155 369 755 253 1641 -299 2280 -438 507 -1114 774 -1782 704z m361 -169 c678 -55 1263 -452 1565 -1063 300 -608 250 -1337 -130 -1898 -39 -57 -81 -116 -94 -132 l-23 -27 -150 56 c-82 31 -295 105 -474 165 l-325 108 -3 80 c-3 86 -1 94 83 310 20 52 45 130 55 175 11 51 31 103 53 140 43 69 80 178 102 295 19 106 19 164 -1 232 -19 63 -15 206 11 383 14 88 15 123 6 191 -37 278 -221 507 -476 593 -119 40 -175 47 -355 46 -146 -1 -188 -5 -255 -23 -103 -28 -204 -76 -282 -135 -195 -148 -308 -437 -264 -672 5 -27 14 -110 20 -185 10 -117 9 -142 -5 -190 -41 -137 18 -429 114 -567 10 -15 28 -68 40 -118 11 -50 37 -133 57 -185 44 -111 57 -186 53 -294 l-3 -80 -285 -95 c-157 -53 -352 -122 -435 -154 -82 -32 -163 -63 -179 -68 -34 -13 -40 -6 -147 151 -380 561 -430 1290 -130 1898 308 623 900 1017 1601 1066 97 7 132 7 256 -3z"/></g></svg>`;
const msgIcon = `<svg version="1.2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="50px" height="50px" viewBox="0 0 64 55.45"><path d="M 32.014 0 C 49.667 0 64 11.25 64 25.13 C 64 39.021 49.667 50.301 32.014 50.301 C 27.86 50.301 23.888 49.671 20.247 48.531 C 16.544 51.431 10.292 55.451 4.172 55.451 C 7.366 52.441 8.28 46.561 8.481 42.191 C 3.211 37.711 0 31.721 0 25.13 C 0 11.25 14.332 0 32.014 0 Z"></path></svg>`;
      ...
      >
        ...
        >
          ...
          <button
            ...
            data-sid={props.convo.sid}
            dangerouslySetInnerHTML={{ __html: peopleIcon }}
          ></button>
          {!window.isAdminMonitor ? null : (
            <button
              ...
              className="hoff-converse"
              title="Text this person"
              onClick={(e) => window.hoff.converse(e)}
              data-uid={props.convo.uniqueName ?? ""}
              data-sid={props.convo.sid}
              dangerouslySetInnerHTML={{ __html: msgIcon }}
            ></button>
          )}
        </Box>
        <Box
